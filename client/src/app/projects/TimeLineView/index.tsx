...
const TimelineView = ({id, setIsModalNewTaskOpen}: Props) => {
    ...
    const [displayOptions, setDisplayOptions] = useState<DisplayOption>({
      ...
      //Usamos El hook useMemo, para guardar los tasks y ponerlos en el diagrama de gantt, y evitar que se haga una y otra vez
  ...
  return (
    ...
    <div className="px-4 xl:px-6">
      ...
      <h1 className="me-2 text-lg font-bold dark:text-white">
        ...
        {/**Select para Seleccionar el modo del gantt */}
