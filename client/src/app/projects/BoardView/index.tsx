...
return(
    ...
    {task.attachments && task.attachments.length > 0 && (
        <Image
          ...
          src={`https://pm-s3-yoex-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        {task.assignee && (
              <Image
                ...
                src={`https://pm-s3-yoex-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-s3-yoex-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
