...
const [isModalNewProjectOpen, setIsModalNewProjectOpen] = useState(false);
  ...
  return (
    <div className='px-4 xl:px-6'>
        {/**MODAL NEW PROJECT  -- BOTON PARA CREAR BOARDS*/}
      ...
      />
        ...
        <div className='pb-6 pt-6 lg:pb-4 lg:pt-8'>
          ...
          {/**Le podemos pasar un componente boton, ya que por props recibe un parametro button tipo any */}
